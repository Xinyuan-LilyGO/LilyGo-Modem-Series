...
[English](../../../en/esp32s3/sim7080-s3-standard/README.MD) | [中文](./README.MD)
...
* 本页介绍 `LilyGo T-SIM7080G-S3-Standard` 相关的硬件参数
...
[1]: https://lilygo.cc/products/t-sim-t-a-series-standard-edition?variant=52513685504181

### 模块参数

| 型号    | GPS | 电话 | SMS | Frequency band(**Cat-M**)                                         | Frequency band(**Cat-NB**)                                    |
| -------- | --- | ---------- | --- | ----------------------------------------------------------------- | ------------------------------------------------------------- |
...
| GPS Ant Power Disable | 5        | Low         | `AT+SGPIO=0,5,1,0` |

> [!IMPORTANT]
> 🚨 **使用 GPS/GNSS 前必须先开启有源天线供电！** SIM7080 使用模块 GPIO5 控制天线电源；请先发送 `AT+SGPIO=0,5,1,1` 开启供电，否则将无法定位或无法获得 GPS fix。不使用 GPS/GNSS 时，可发送 `AT+SGPIO=0,5,1,0` 关闭天线供电以降低功耗。
...
* [T-SIM7080G-S3-Standard 原理图](../../../../schematic/standard/T-SIM7080G-S3-Standard_Rev1.0.pdf)
...
* [3D 模型](../../../../dimensions/Standard/T-SIM7080G-S3-Standard.7z)
* [尺寸 svg](../../../../dimensions/Standard/T-SIM7080G-S3-Standard.svg)

### 常见问题

* **升级模块固件**
  1. [SIM7080G 升级文档](./upgrade/README.MD)
