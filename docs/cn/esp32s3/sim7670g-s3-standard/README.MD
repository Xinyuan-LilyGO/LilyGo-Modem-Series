...
[English](../../../en/esp32s3/sim7670g-s3-standard/README.MD) | [中文](./README.MD)
...
* 本页介绍 `LilyGo T-SIM7670G-S3-Standard` 相关的硬件参数
...
> [!IMPORTANT]
> 🚨 **使用 GPS/GNSS 前必须先开启有源天线供电！** SIM7670G Standard 使用模块 GPIO1 控制天线电源；请先发送 `AT+CGDRT=1,1; AT+CGSETV=1,1` 开启供电，否则将无法定位或无法获得 GPS fix。不使用 GPS/GNSS 时，可发送 `AT+CGDRT=1,1; AT+CGSETV=1,0` 关闭天线供电以降低功耗。
...
* [T-SIM7670G-S3-Standard 原理图](../../../../schematic/standard/T-A7670X-S3-Standard_Rev1.0.pdf)
