...
[English](./README.MD) | [中文](../../../cn/esp32/a7670-esp32/README.MD)
...
| Model           | GPS | Phone Call | SMS | Frequency band                                                                              | Note                 |
| --------------- | --- | ---------- | --- | ------------------------------------------------------------------------------------------- | -------------------- |
| A7670E-FASE     | ✅   | ✅          | ✅   | LTE-FDD:B1/B3/B5/B7/B8/B20  GSM:900/1800                                                    | GPS Version          |
| A7670E-LASE     | ❌   | ✅          | ✅   | LTE-FDD:B1/B3/B5/B7/B8/B20  GSM:900/1800                                                    | With out GPS version |
| A7670SA-FASE    | ✅   | ✅          | ✅   | LTE-FDD:B1/B2/B3/B4/B5/B7/B8/B28/B66  GSM:850/900/1800/1900                                 | GPS Version          |
| A7670SA-LASE    | ❌   | ✅          | ✅   | LTE-FDD:B1/B2/B3/B4/B5/B7/B8/B28/B66  GSM:850/900/1800/1900                                 | With out GPS version |
| A7670G-LLSE     | ❌   | ✅          | ✅   | LTE-FDD:B1/B2/B3/B4/B5/B7/B8/B20/B28/B66  LTE-TDD:B34/B38/B39/B40/B41 GSM:850/900/1800/1900 | With out GPS version |
| A7670E-LNXY-UBL | ❌   | ❌          | ❌   | LTE-FDD:B1/B3/B5/B7/B8/B20                                                                  | Only 4G Version      |
...
6. In Arduino IDE, select the corresponding board in the tool project and click on the corresponding option in the list below to select
...
>
> GPIO5 (Modem RST) is exposed on the header. Do not connect any wires to the GPIO5 position on the header; keep it disconnected.
>
...
> \[!IMPORTANT]
>
> The board may reset and restart the device when switching between USB and battery. This is normal, as the board does not have a seamless power switching solution.
>
> This behavior cannot be affected by software settings.
>
...
* [L76K GPS Module Schematic](../../../../schematic/shield/Extern-GPS-Module.pdf)
...
* [L76K GPS Module datasheet](../../../../datasheet/GPS/)
...
* **How to use the LoRa expansion board with the T-A7670?**
  1. The [Lora expansion](https://lilygo.cc/products/ttgo-accessories-shield-lora-868-915-mhz) board cannot be used simultaneously with the T-A7670G+L76K GPS; other versions can.
  1. To use with the T-A7670, the RST resistor on the modem needs to be removed,See [issue/160](https://github.com/Xinyuan-LilyGO/LilyGo-Modem-Series/issues/160)
