...
<h1 align = "center">🌟LilyGo T-SIM7600X-S3-Standard🌟</h1>

<div align="center">

[English](./README.MD) | [中文](../../../cn/esp32s3/sim7600g-s3-standard/README.MD)

</div>

## Overview

* This page introduces the hardware parameters related to `LilyGo T-SIM7600X-S3-Standard`

### Product

| Product                  | SOC              | Flash          | PSRAM         |
| ------------------------ | ---------------- | -------------- | ------------- |
| [T-SIM7600X-Standard][1] | ESP32-S3-WROOM-1 | 16MB(Quad-SPI) | 2MB(Quad-SPI) |

[1]: https://lilygo.cc/products/t-sim-t-a-series-standard-edition?variant=52513685536949
...
* The voice call version requires the purchase of an audio package; otherwise, voice calls are not possible.


* The T-SIM7600X-S3-Standard comes with audio and modem TF card functionality by default. To use these functions, you need to purchase the T-SIM7600G-S3-Standard-ExpansionKit. The table below lists the functional changes after adding the T-SIM7600G-S3-Standard-ExpansionKit.

| Function               | T-SIM7600X-S3-Standard | T-SIM7600X-S3-Standard +  ExpansionKit | Note                              |
| ---------------------- | ---------------------- | -------------------------------------- | --------------------------------- |
| Headphone jack         | ❌                      | ✅                                      | Mono 3.5mm                        |
| Speaker interface      | ❌                      | ✅                                      | 2W audio power amplifier          |
| Modem TF card function | ❌                      | ✅                                      | SIM7600G Direct Access to TF Card |
...
7. Cancel the `;` symbol in front of the line `default_envs = T-SIM7600X-S3-Standard` and use `T-SIM7600X-S3-Standard` as the default environment
...
5. In Arduino IDE, select the corresponding board in the tool project and click on the corresponding option in the list below to select
...
6. In the open sketch, select the `utilities.h` file and uncomment the line `// #define LILYGO_SIM7600X_S3_STAN`. Delete the `//` and save the file to use this board as the default configuration.
...
| --------------------- | --------- | ------------ | -------------------------------- |
| GPS Ant Power Enable  | AUX Power | High         | `AT+CVAUXV=2800;AT+CVAUXS=1`     |
| Audio Pa Power Enable | 77        | High         | `AT+CGDRT=77,1 ; AT+CGSETV=77,1` |

> [!IMPORTANT]
> 🚨 **Before using GPS/GNSS, you must enable the modem's 2.8 V AUX supply for the active antenna by sending `AT+CVAUXV=2800; AT+CVAUXS=1`; otherwise, the modem cannot obtain a position fix. Disable the antenna power with `AT+CVAUXS=0` when GPS/GNSS is not in use.**
...
* `GPS Shield Wakeup Pin` is only used when an external GPS module is connected. Otherwise, it is idle. It is not recommended to use this GPIO. SIM7600G Using internal GPS, so this pin is useless
...
* `Audio Pa Power Enable` : When using Audio amplifier, you must set the modem's GPIO77 to high level by sending `AT+CGDRT=77,1 ; AT+CGSETV=77,1`. When not using Audio amplifier, you can send `AT+CGDRT=77,1 ; AT+CGSETV=77,0` to turn off the Audio amplifier power supply and save power.(The audio amplifier is not included in the main unit by default and requires a corresponding expansion board.)
...
* [T-SIM7600G-S3-Standard Schematic](../../../../schematic/standard/T-SIM7600G-S3-Standard_Rev1.0.pdf)
* [T-SIM7600G-S3-Standard-ExpansionKit](../../../../schematic/standard/T-SIM7600G-S3-Standard-ExpansionKit_Rev1.0.pdf)
* [SIMCOM official SIM7600G All Datasheet](https://cn.simcom.com/product/SIM7600X.html)
* [For SIM7600G series documentation, please visit the datasheet directory.](../../../../datasheet/SIM7600X/)
* [3D](../../../../dimensions/Standard/T-SIM7600G-S3-Standard.7z)
* [Dimensions svg](../../../../dimensions/Standard/T-SIM7600G-S3-Standard.svg)
* [T-SIM7600G-S3-Standard-ExpansionKit-3D](../../../../dimensions/Standard/T-SIM7600G-S3-Standard-ExpansionKit.7z)
* [T-SIM7600G-S3-Standard-ExpansionKit-Dimensions svg](../../../../dimensions/Standard/T-SIM7600G-S3-Standard-ExpansionKit-Top.svg)

### FAQ

* **Upgrade modem firmware**
  1. [SIM7600G Upgrade docs](../../../../docs/en/esp32/sim7600-esp32/upgrade/sim7600_upgrade.md)
